    ...
    handleMovement(time, delta) {
        ...
        if (this.isMoving) {
            ...
            if (wantToSprint) {
                ...
                this.currentSpeed = Phaser.Math.Linear(this.currentSpeed, PLAYER_MAX_SPRINT_SPEED, 0.1);
                ...
                this.currentSpeed = Phaser.Math.Linear(this.currentSpeed, targetSpeed, 0.1);
            }
            ...
            // Debug logging för att verifiera rörelse
            console.log(`Player movement - dx: ${dx}, dy: ${dy}, Virtual Keys:`, window.virtualKeys);
        } else {
            // Sakta ner när vi inte rör oss
            if (this.currentSpeed > this.speed) {
                this.currentSpeed = Phaser.Math.Linear(this.currentSpeed, this.speed, 0.15);
            }
            this.isSprinting = false;
        }
    }
